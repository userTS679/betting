...
export const PaymentManagement: React.FC<PaymentManagementProps> = ({
  ...
  const getTransactionIcon = (type: string) => {
    switch (type) {
      ...
      case 'bet_placed': return <Minus className="w-5 h-5 text-orange-600" />;
      case 'bet_won': return <TrendingUp className="w-5 h-5 text-green-600" />;
      case 'bet_lost': return <TrendingDown className="w-5 h-5 text-red-600" />;
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">Manage your wallet, track earnings, and view transaction history</p>
      </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <div className="text-2xl font-bold text-gray-900">{formatCurrency(stats.totalDeposited)}</div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <div className="text-2xl font-bold text-green-600">{formatCurrency(stats.totalWinnings)}</div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <div className="text-2xl font-bold text-red-600">{formatCurrency(stats.totalLosses)}</div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="font-semibold">{formatCurrency(stats.totalBetAmount)}</span>
              </div>
              <div className="flex justify-between items-center">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                ...
                <span className="font-semibold text-green-600">+{formatCurrency(stats.totalDeposited)}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-600">Money Withdrawn</span>
                <span className="font-semibold text-red-600">-{formatCurrency(stats.totalWithdrawn)}</span>
              </div>
              <div className="flex justify-between items-center">
              ...
              <div className="pt-2 border-t">
                <div className="flex justify-between items-center">
                  ...
                  <span className={`font-bold text-lg ${
                    (stats.totalDeposited - stats.totalWithdrawn + stats.netProfit) >= 0 ? 'text-green-600' : 'text-red-600'
                  }`}>
